...
\setmonofont{Courier New}[Scale=MatchLowercase] % Schreibmaschinenschrift
\else
...
\UseTblrLibrary{booktabs, siunitx} % für Kompatibilität
\usepackage[ngerman, colorinlistoftodos]{todonotes} % TODO-Liste
